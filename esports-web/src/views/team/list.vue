      ...
      <div v-loading="loading" class="team-grid">
        <el-row :gutter="20">
          <el-col :span="6" v-for="team in teams" :key="team.id">
            <el-card class="team-card" :body-style="{ padding: '0px' }" shadow="hover">
              ...
              <div class="team-detail">
                ...
                <div class="actions">
                  ...
                  <el-button type="primary" link @click="joinTeam(team.id)">申请加入</el-button>
                </div>
              </div>
            </el-card>
          </el-col>
...
.btn-my-team {
  background-color: #ff4d4f !important; /* 浅红底（根据需求改为明显的红底白字） */
