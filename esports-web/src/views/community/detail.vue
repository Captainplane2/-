          ...
          <el-card shadow="never" class="post-card" v-if="post">
            ...
            <div class="p-meta">
              <div class="author-info">
                <el-avatar :size="32" :src="post.avatar ? (post.avatar.startsWith('http') ? post.avatar : env.getFullApiUrl(post.avatar)) : 'https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png'" />
          ...
          <el-card shadow="never" class="comment-card" v-if="post" style="margin-top: 20px">
            ...
            <div class="comment-list">
              <div v-for="c in comments" :key="c.id" class="comment-item">
                <el-avatar :size="40" :src="c.avatar ? (c.avatar.startsWith('http') ? c.avatar : env.getFullApiUrl(c.avatar)) : 'https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png'" />
      ...
      <el-col :span="6">
        <el-card shadow="never" class="sidebar-card">
          ...
          <div v-if="post" class="author-sidebar">
            <el-avatar :size="60" :src="post.avatar ? (post.avatar.startsWith('http') ? post.avatar : env.getFullApiUrl(post.avatar)) : 'https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png'" />
